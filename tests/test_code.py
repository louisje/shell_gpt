...
def test_code_generation():
    completion = CompletionMock(return_value=mock_comp("print('Hello World')"))
...
def test_code_generation_no_markdown(markdown_printer, text_printer):
    completion = CompletionMock(return_value=mock_comp("print('Hello World')"))
    with patch("sgpt.handlers.handler.completion", completion):
...
def test_code_generation_stdin():
    completion = CompletionMock(return_value=mock_comp("# Hello\nprint('Hello')"))
    with patch("sgpt.handlers.handler.completion", completion):
...
def test_code_chat():
    completion = CompletionMock(side_effect=[
